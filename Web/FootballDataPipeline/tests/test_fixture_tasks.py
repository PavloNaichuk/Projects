...
def test_sync_live_fixtures_task_runs_async_service() -> None:
    expected_result = {
        "fixtures_synced": 1,
    }
    ...
    with patch(
        ...
        result = sync_live_fixtures_task.run(39, 2024)
    ...
    assert result == expected_result
    assert sync_live_fixtures_task.name == "football.sync_live_fixtures"
