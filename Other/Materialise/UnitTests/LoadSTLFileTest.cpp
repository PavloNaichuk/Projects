...
namespace UnitTests
{
	...
	public:
		TEST_METHOD(TestLoad)
		{
			...
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad.stl");
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_MissingNormalCoord.stl");
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_InvalidNormalFormat.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_MissingNormal.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_InvalidVertexFormat.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_MissingVertex.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_MissingVertexCoord.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_EmptyFile.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_InvalidSolidAttribute.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_InvalidFacetAttribute.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_InvalidNormalAttribute.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_InvalidOuterAttribute.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_InvalidVertexAttribute.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_InvalidEndloopAttribute.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_InvalidEndfacetAttribute.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		
		TEST_METHOD(TestLoad_InvalidEndsolidAttribute)
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad_InvalidEndsolidAttribute.stl");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
		...
		{
			auto result = loadSTLFile(L"../UnitTests/TestFiles/TestLoad.std");
			Assert::IsFalse(result.second);
			Assert::IsTrue(result.first.empty());
		}
	};
